        ...
        <section class="bg-white shadow-md rounded-lg p-4">
            ...
            <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="title" name="title" placeholder="Enter post title" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring focus:ring-blue-500" value="{{ old('title') }}">
                </div>
                ...
                <div class="mb-4">
                    ...
                    <textarea id="content" name="content" rows="4" required class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring focus:ring-blue-500" placeholder="Write your post content here...">{{ old('content') }}</textarea>
                </div>
