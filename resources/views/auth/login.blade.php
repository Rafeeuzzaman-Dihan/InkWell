    ...
    <div class="min-h-screen flex items-center justify-center py-6 px-4">
        <div class="grid md:grid-cols-2 items-center gap-10 max-w-6xl w-full">
            ...
            <form action="{{ route('login') }}" method="POST" class="bg-white shadow-md rounded-lg p-8 w-full">
                ...
                <h3 class="text-gray-800 text-3xl font-extrabold mb-8 text-center">Sign in</h3>
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-center justify-between gap-4">
                        ...
                        <div class="text-sm">
                            <a href="{{ route('forgot_password') }}" class="text-blue-600 hover:text-blue-500 font-semibold">
